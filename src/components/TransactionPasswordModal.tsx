    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 relative">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Transaction Password</h2>
        ...
        <div className="mb-6">
          <div className="flex justify-center space-x-3 mb-4">
            {(step === 'password' ? password : confirmPassword).map((digit, index) => (
              <input
                key={index}
                ref={(el) => {
                  if (step === 'password') {
          ...
          <div className="flex justify-center space-x-2 mb-4">
            <div className={`w-3 h-3 rounded-full ${step === 'password' ? 'bg-purple-600' : 'bg-green-500'}`}></div>
            <div className={`w-3 h-3 rounded-full ${step === 'confirm' ? 'bg-purple-600' : 'bg-gray-300'}`}></div>
          </div>
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            disabled={loading || (step === 'password' ? password.join('').length !== 6 : confirmPassword.join('').length !== 6)}
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          <div className="flex items-start">
            ...
            <div className="text-blue-800 text-xs">
              ...
              <p>This is the same 6-digit password you set when creating your wallet. It&apos;s used to authorize transactions.</p>
            </div>
          </div>
        </div>
      </div>
