...
export default function TransactionExplorer({ 
  ...
  const [detectedNetwork, setDetectedNetwork] = useState<'ethereum' | 'bsc'>('ethereum')
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              {totalTransactions > 0 && `${totalTransactions} transactions found`}
              {detectedNetwork && (
              ...
              {transactions.map((transaction) => (
                <tr key={transaction.hash} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full border ${getTypeStyle(transaction.type)}`}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                    <span className="font-mono">{truncateAddress(transaction.to)}</span>
                  </td>
