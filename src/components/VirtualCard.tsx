...
export default function VirtualCard({
  ...
  const cardBrandLogos = {
    VISA: <div className='text-white font-bold text-xl italic'>VISA</div>,
    MASTERCARD: (
    ...
    AMEX: <div className='text-white font-bold text-lg'>AMEX</div>,
  };
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div className='flex justify-between items-center mb-4'>
        <span
          className={`px-3 py-1 rounded-full text-sm font-medium ${statusColors[card.status]}`}
        >
          {card.status}
        </span>
      ...
      <div className='relative w-full max-w-sm mx-auto'>
        ...
        >
          {/* Front of Card */}
          <div
            className={`absolute inset-0 w-full h-full rounded-2xl shadow-2xl bg-gradient-to-br ${cardBrandColors[card.cardBrand]} p-6 text-white backface-hidden`}
          >
            {/* Card Header */}
          ...
          {/* Back of Card */}
          <div
            className={`absolute inset-0 w-full h-full rounded-2xl shadow-2xl bg-gradient-to-br ${cardBrandColors[card.cardBrand]} p-6 text-white backface-hidden rotate-y-180`}
          >
            {/* Magnetic Stripe */}
