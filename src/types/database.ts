...
export type UserAssetPriority = Database['public']['Tables']['user_asset_priorities']['Row']
export type VirtualCardTransaction = Database['public']['Tables']['virtual_card_transactions']['Row'] 