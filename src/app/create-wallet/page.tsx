...
export default function CreateWallet() {
  ...
  const handleKeyDown = (index: number, e: React.KeyboardEvent, isConfirm: boolean) => {
    if (e.key === 'Backspace') {
      const currentArray = isConfirm ? formData.confirmPassword : formData.password
  ...
  const handlePasswordConfirm = () => {
    ...
    if (password !== confirmPassword) {
      setError(`Passwords do not match. Password: "${password}", Confirm: "${confirmPassword}"`)
      setCurrentStep('password')
      setFormData({
        ...formData,
        password: ['', '', '', '', '', ''],
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100">
      <div className="max-w-lg mx-auto p-6">
        ...
        <div className="text-center mb-8 pt-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Create New Wallet</h1>
          <p className="text-gray-600">BSC Mainnet wallet with real blockchain integration</p>
        </div>
              ...
              <div key={step} className="flex items-center">
                ...
                {step < 5 && (
                  <div className={`w-12 h-1 mx-2 ${
                    step < getStepNumber() ? 'bg-gradient-to-r from-purple-600 to-blue-600' : 'bg-gray-200'
                  }`}></div>
                )}
              </div>
            ))}
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {currentStep === 'username' && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">Choose a unique username for your wallet</p>
              </div>
          ...
          {currentStep === 'password' && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">Set a 6-digit transaction password</p>
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700 mb-4 text-center">Transaction Password</label>
                ...
                <p className="text-xs text-gray-500 text-center mt-2">Enter 6 digits for your transaction password</p>
              </div>
          ...
          {currentStep === 'confirm' && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">Confirm your transaction password</p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 text-center mt-2">Re-enter your 6-digit password</p>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-start">
                  ...
                  <div className="text-blue-800 text-sm">
                    ...
                    <p>Your wallet will be created on BSC Mainnet with real blockchain integration. Keep your private keys and transaction password safe!</p>
                  </div>
                </div>
              </div>
          ...
          {currentStep === 'creating' && (
            <div className="space-y-6 text-center">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Creating Your Wallet</h3>
                <p className="text-gray-600">Please wait while we set up your BSC Mainnet wallet...</p>
              </div>
