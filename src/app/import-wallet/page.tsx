        ...
        <div className='bg-white rounded-2xl shadow-xl p-8'>
          <div className='text-center mb-8'>
            ...
            <p className='text-gray-600'>
              Enter your primary private key or backup access key to access your
              BSC wallet
            </p>
          </div>
              ...
              <div className='flex'>
                ...
                <div className='ml-3'>
                  <p className='text-sm text-yellow-700'>
                    <strong>Security Warning:</strong> Never share your private
                    key with anyone. This is a demo application.
                  </p>
                </div>
              </div>
            </div>
