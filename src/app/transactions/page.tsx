  ...
  const detectNetworkFromAddress = async (walletAddress: string) => {
    ...
    try {
      const response = await fetch(
        `/api/get-wallet-network?address=${encodeURIComponent(walletAddress.trim())}`
      );
      ...
      <div className='max-w-7xl mx-auto p-6'>
        ...
        <div className='text-center mb-8'>
          ...
          <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
            ...
            Track deposits, withdrawals, and token transfers with detailed
            categorization.
          </p>
        </div>
              ...
              <div className='md:col-span-2'>
                ...
                <div className='relative'>
                  <select
                    ...
                    value={network}
                    onChange={e =>
                      setNetwork(e.target.value as 'ethereum' | 'bsc')
                    }
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
            <div className='text-center'>
              ...
              <p className='text-sm text-gray-600'>
                Direct API integration with Etherscan and BSCScan
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-sm text-gray-600'>
                Automatically categorizes deposits, withdrawals, and token
                transfers
              </p>
            </div>
            ...
            <div className='text-center'>
              <div className='inline-flex items-center justify-center w-12 h-12 bg-purple-100 rounded-full mb-4'>
                ...
                >
                  <path
                    ...
                    strokeLinejoin='round'
                    strokeWidth={2}
                    d='M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17v4a2 2 0 002 2h4M11 7l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485'
                  />
                </svg>
              </div>
              <h3 className='text-lg font-medium text-gray-900 mb-2'>
              ...
              <p className='text-sm text-gray-600'>
                Detects and displays ERC20 token transfers with symbols and
                amounts
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-sm text-gray-600'>
                Direct links to blockchain explorers for detailed transaction
                info
              </p>
            </div>
          </div>
