    ...
    const fetchPriorities = async () => {
      ...
      try {
        ...
        if (response.ok && data.success) {
          ...
          if (data.isDefault) {
            setMessage(`Default priorities created based on your ${data.availableTokens?.length || 0} tokens. You can customize them below.`)
          }
          if (data.message) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 flex items-center justify-center">
        <div className="max-w-md w-full mx-4">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Missing required user information.</p>
            <Link
              href="/"
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100">
      <div className="max-w-2xl mx-auto p-6">
          ...
          <div className="flex">
            ...
            <div>
              ...
              <ul className="text-blue-800 text-sm space-y-1">
                <li>• Assets with higher priority (top of list) will be used first</li>
                <li>• Use ↑ ↓ buttons to reorder your preferences</li>
                <li>• Toggle switches to enable/disable specific assets</li>
                <li>• Changes are saved automatically when you click &ldquo;Save Priorities&rdquo;</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-6">Your Asset Priority Order</h2>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-4">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold ${asset.color}`}>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-900">{priority.token_symbol}</h3>
